...
export default function SpendingAnalysisTab() {
  ...
  const getAlertIcon = (severity: string) => {
    switch (severity) {
      case 'high': return <WarningIcon sx={{ color: '#e53e3e' }} />;
      case 'medium': return <WarningIcon sx={{ color: '#f6ad55' }} />;
      case 'low': return <CheckCircleIcon sx={{ color: '#38b2ac' }} />;
          ...
          <Paper elevation={2} sx={{ p: 3, borderRadius: 3, height: '100%' }}>
            ...
            <Box sx={{ 
              ...
              <Typography variant="body2" color="text.secondary">
                Average per category: {formatCurrency(totalSpending / spendingByCategory.length)}
              </Typography>
            </Box>
          </Paper>
        </Grid>
